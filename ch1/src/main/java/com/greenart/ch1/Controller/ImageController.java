			...
			if(file.getSize() >0 && StringUtils.isNotBlank(file.getName())) {
				if(file.getContentType().toLowerCase().startsWith("image/")) {
				    try{
			            ...
			            //String uploadPath = "C:\\Users\\green\\git\\BCtour\\ch1\\src\\main\\webapp\\resources\\img";
			            ...
			            //String fileUrl = "C:\\Users\\green\\git\\BCtour\\ch1\\src\\main\\webapp\\resources\\img\\"+fileName2 +fileName;
