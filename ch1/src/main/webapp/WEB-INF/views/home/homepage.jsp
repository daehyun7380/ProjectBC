...
<head>
   ...
   <meta charset="UTF-8">
    <title>비씨투어</title>
    <link rel="stylesheet" href="${path }/resources/CSS/BCtourMainStyle.css?aasdnna">
    <link rel="stylesheet" href="${path }/resources/CSS/slider1.css?asdnnaf">
                    ...
                    <div class ="reviewMain">
                        <div class ="review1">
                            ...
                            <div class="reviewContent">
                                <a href="<c:url value='/board/read_2?rec_num=${topList[0].rec_num}'/>"><p>${topList[0].rec_content}</p>
                                </a>
                            </div>
                        </div>    
                        <div class="reviewImg">
