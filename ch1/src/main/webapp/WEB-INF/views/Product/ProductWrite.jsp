                        ...
                        <table class="tour_desc">
                            <tbody class="t_desc_tbl">
                                <tr>
                                    ...
                                    <td><input type="text" name="pd_days" placeholder="여행기간"></td>
                                </tr>
                                <tr>
                                <th class="t_th">이용 교통</th>
                                <td style="padding-bottom: 0;">
                                    <div class="transport">
                                        <p><input type="text" name="pd_transport" placeholder="버스or항공"></p>
                                    </div>  
                                    <div class="deportDepart">
                                        <div class="depart">
                                        		<dt>출발일 : <input type="text" name="pd_departDay" placeholder="2022.12.07"></dt>
                                                <dt>출발 : <input type="text" name="pd_departStart" placeholder="12:00"></dt>
                                                <dt>도착 : <input type="text" name="pd_departEnd" placeholder="13:00"></dt>
                                        </div>
                                        <div class="deport">
                                        	<dt>복귀일 : <input type="text" name="pd_deportDay" placeholder="2022.12.08"></dt>
                                            <dt>출발 : <input type="text" name="pd_deportStart" placeholder="12:00"></dt>
                                            <dt>도착 : <input type="text" name="pd_deportEnd" placeholder="13:00"></dt>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="pd_visitCity" placeholder="방문도시">
                                </td>
                            </tr>
                            <tr>
                            	<th class="t_th">가격</th>
                            	<td>
                                    <input type="text" name="pd_price" placeholder="가격">
                                </td>
                            </tr>
                        </tbody>
                    </table>
