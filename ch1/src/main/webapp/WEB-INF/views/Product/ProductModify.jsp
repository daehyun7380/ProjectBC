                        ...
                        <table class="tour_desc">
                            <tbody class="t_desc_tbl">
                                <tr>
                                    ...
                                    <td><input type="text" name="pd_days" value="${modi.pd_days }" placeholder="여행기간"></td>
                                </tr>
                                <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="pd_visitCity" value="${modi.pd_visitCity }" placeholder="도시1">
...
$(document).ready(function(){
	...
	function modi(){
		...
		console.log(form)
		form.action="<c:url value="/ProductModify"/>?pd_num=${modi.pd_num}";
		form.method="post";
		form.submit();
	}
