...
<body>
	<div class="main">
    	<div class="allDiv">
            ...
            <div class ="nav">
                <div id="column">
                    <div class="city">
                        <h2><a id="select" href="<c:url value='/board/list_1'/>">공지사항</a></h2>
                    </div>
                    <div class="city">
                        <h2><a href="<c:url value='/board/list_2'/>">여행일지</a></h2>
                    </div>
                    <div class="city">
                ...
                <div class="column2">
                    ...
                    <div class="b_content">
                    	...
                    	<div class="b_pageNavi">
                    		...
                    		<a href="<c:url value='/board/list_1${ph.sc.getQueryString(ph.beginPage-1)}'/>"><div class="b_preNext">이전</div></a>
                    		</c:if>
                    		<c:forEach var="i" begin="${ph.beginPage}" end="${ph.endPage}">
                    		<c:if test="${i == page}">
                    		<a href="<c:url value='/board/list_1${ph.sc.getQueryString(i)}'/>"><div id="select" class="b_pageNum">${i}</div></a>
                    		</c:if>
                    		<c:if test="${i != page}">
                    		<a href="<c:url value='/board/list_1${ph.sc.getQueryString(i)}'/>"><div class="b_pageNum">${i}</div></a>
                    		</c:if>
                    		</c:forEach>
                    		<c:if test="${ph.showNext}">
                    		<a href="<c:url value='/board/list_1${ph.sc.getQueryString(ph.endPage+1)}'/>"><div class="b_preNext">다음</div></a>
                    		</c:if>
                    	</div>
                    	<div class="b_searchboardarea">
                    	<form action="<c:url value='/board/list_1'/>" class="b_searchform" method="get">
	...
	<script>
		...
		window.location = "<c:url value='/board/write_1'/>";
		});
