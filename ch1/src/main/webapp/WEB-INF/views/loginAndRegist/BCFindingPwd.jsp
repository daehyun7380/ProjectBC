		...
		<div>
			...
			<div id="container">
				<ul>
					...
					<li id="findpwd"><a href="<c:url value='/BCFind/BCFindingPwd'/>">비밀번호</a></li>
				</ul>
			</div>
			<div class="h2_box"><h2>등록한 이메일로 비밀번호 찾기</h2></div>
		</div>
	</div>
	<!-- 비밀번호 찾기 -->
	<form action="<c:url value='/BCFind/BCFindingPwd'/>" id="form" method="post" onsubmit="return ConfirmBtn();">
        <div id="form_container">
        	<div class="form_container_pwd">
				<input type="text" name="id" id="id" value="${param.id2 }" placeholder="아이디" required="required">
			</div>
            <div class="form_container_pwd">
                <input type="text" name="name" id="name" value="${param.name2 }" placeholder="이름" required="required">
            </div>
        <div class="form_container_pwd">
            <div>
