...
<body>
                ...
                <div class="column2">
                	<div class="b_writecontent">
						<div class="b_writebtn">
							<input type="hidden" name="ques_num" value="${quesDto.ques_num}" readonly="readonly">
						...
						<div class="b_writetitlearea">
							<input class="b_writetitle" id="ques_title" type="text" name="ques_title" placeholder="제목을 입력해 주세요">
						</div>
						<div class="b_writecontentarea">
							<textarea name="ques_content" id="ques_content" class="b_textarea" placeholder="내용을 입력해 주세요."></textarea>
						</div>
					</div>
                </div>
                </form>
	...
	form.action="<c:url value='/myPage/write_question'/>";
	form.method="post"
	form.submit();
	});
