...
<body>
            ...
            <div class ="nav">
                ...
                <div class="column2">
                	<div class="b_readcontent">
						...
						<fmt:formatDate value="${quesDto.ques_date}" pattern="yyyy-MM-dd HH:mm:ss" var="regDate" />
							작성자: ${quesDto.ques_writer},&nbsp;&nbsp; 등록일: ${regDate}
						</div>
						<div class="b_readcontentarea" id="content">
							${quesDto.ques_content}
						</div>
					</div>
                </div>
                </form>
	...
	<script>
		...
		window.location = "<c:url value='/myPage/manage_questions'/>?page=${page}&pageSize=${pageSize}";
		});
		...
		form.action="<c:url value='/myPage/remove_question'/>?page=${page}&pageSize=${pageSize}";
		form.method="post"
		form.submit();
		});
